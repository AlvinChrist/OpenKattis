...
int path(int r1,int c1,int r2,int c2,int row,int col,vector<vector<int>> map){
    ...
    while(true){
        ...
        if(_r1==r2 && _c1==c2){
            ...
            //cout<<_r1<<" "<<_c1<<'\n';
            bool step=false;
            if(_c1<col  && step==false && map[_r1][c]==dest){
                //cout<<"right"<<'\n';
                last.pb(3);
                map[_r1][_c1]=9;
                _c1++;
            ...
            else if(_r1<row  && step==false && map[r][_c1]==dest){
                //cout<<"down"<<'\n';
                last.pb(1);
                map[_r1][_c1]=9;
                _r1++;
            ...
            else if(_c1>0  && step==false && map[_r1][_c]==dest){
                //cout<<"left"<<'\n';
                last.pb(4);
                map[_r1][_c1]=9;
                _c1--;
            }
            else if(_r1>0 && step==false && map[_r][_c1]==dest){
                //cout<<"up"<<'\n';
                last.pb(2);
                map[_r1][_c1]=9;
                _r1--;
